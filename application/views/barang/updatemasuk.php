        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="jumlahMasuk" name="jumlahMasuk" value="<?= $barang['jumlah_masuk']; ?>">
                    </div>
                </div>

                <div class="form-group row justify-content-end">
                    <div class="col-sm-10">
                        <a href="<?= base_url('barang/barangmasuk'); ?>" class="btn btn-secondary">Cencel</a>
